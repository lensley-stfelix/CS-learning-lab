...
#this is player KelsX’s first move
col = int(input("KelsX player, select a column 1-3: "))
row = int(input("KelsX player, select a row 1-3: "))
col -= 1
row -= 1
board[row][col] = "X"
print(board[0])
...
col = int(input("LensO player, select a column 1-3: "))
row = int(input("LensO player, select a row 1-3: "))
col -= 1
row -= 1
board[row][col] = "O"
print(board[0])
...
print(board[2])
 ...
 #this is player KelsX’s second move
